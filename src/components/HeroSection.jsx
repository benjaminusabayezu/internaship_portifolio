      ...
      >
        ...
        <div className="container mx-auto px-6 lg:px-20 xl:px-28 flex flex-col xl:flex-row items-center justify-between gap-16 py-24">
          ...
          <div className="flex-1 max-w-xl z-10">
            ...
            >
              <span className="text-zinc-100"><span className="text-lime-600">L</span>earn</span>
              ...
              <TypeAnimation
                ...
                speed={45}
                repeat={Infinity}
                className="bg-gradient-to-r from-lime-300 via-lime-400 to-green-500 bg-clip-text text-transparent"
              />
            </motion.h1>
            ...
            >
              <button
                ...
                className="px-7 py-3 rounded-full bg-lime-400 text-zinc-900 font-semibold text-sm
